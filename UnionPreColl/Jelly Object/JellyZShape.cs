...
namespace UnionPreColl
{
	...
	{
		public JellyZShape(double mass, double size, Vector pos)
			: base(mass, size, 10)
		{
			//nodes
			...
			_nodes[2] = new JellyVertex(new Vector(pos.X + -1 * size, pos.Y + 1 * size));
			_nodes[3] = new JellyVertex(new Vector(pos.X + -2 * size, pos.Y + 0 * size));
			_nodes[4] = new JellyVertex(new Vector(pos.X + 0 * size, pos.Y + 0 * size));
			_nodes[5] = new JellyVertex(new Vector(pos.X + 2 * size, pos.Y + 0 * size));
			_nodes[6] = new JellyVertex(new Vector(pos.X + -1 * size, pos.Y + -1 * size));
			_nodes[7] = new JellyVertex(new Vector(pos.X + 1 * size, pos.Y + -1 * size));
			_nodes[8] = new JellyVertex(new Vector(pos.X + -2 * size, pos.Y + -2 * size));
			...
			_nodes[11] = new JellyVertex(new Vector(pos.X + 1 * size, pos.Y + -3 * size));
			_nodes[12] = new JellyVertex(new Vector(pos.X + 0 * size, pos.Y + -4 * size));
			_nodes[13] = new JellyVertex(new Vector(pos.X + 2 * size, pos.Y + -4 * size));
